package com.backend.projetointegrador.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> invalidArgs(InvalidArgsException e, HttpServletRequest request) {
